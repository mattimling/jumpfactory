				...
				<?php if ( have_rows( 'holidays', 'options' ) ) : ?>
					<?php while ( have_rows( 'holidays', 'options' ) ) :
						...
						<?php if ( have_rows( 'holidays_popup', 'options' ) ) : ?>
							<div class="fixed top-0 left-0 w-full h-[100dvh] flex justify-center items-center js-holidays-popup opacity-0 invisible pointer-events-none -z-[1] [&.is-open]:opacity-100 [&.is-open]:visible [&.is-open]:pointer-events-auto [&.is-open]:z-[100] transition-all duration-200">
								...
								<div class="bg-charcoal relative z-50 text-beige py-[60px] px-[30px] md:px-[60px] md:rounded-[10px] drop-shadow-lg text-[15px] flex flex-col gap-y-3 leading-[1.3] max-md:overflow-auto max-md:h-[100dvh] max-md:w-full">
									<a href="#" class="absolute top-0 right-0 p-5 hover:opacity-50 transition-all duration-200 js-holidays-popup-close prevent-children">
